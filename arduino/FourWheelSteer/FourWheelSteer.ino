...
const double steerCapableDuty = 0.2, driveCapableDuty = 0.2;
bool Stop = true;
...
void loop()
{
  ...
  static Velocity_PID drivePID[] = {
    {driveMotorNum[0], incEncNum[0], encoderType::inc, INC_CPR, driveCapableDuty, Vkp[0], Vki[0], Vkd[0], angVel[0], false, false},
    {driveMotorNum[1], incEncNum[1], encoderType::inc, INC_CPR, driveCapableDuty, Vkp[1], Vki[1], Vkd[1], angVel[1], false, false},
    {driveMotorNum[2], incEncNum[2], encoderType::inc, INC_CPR, driveCapableDuty, Vkp[2], Vki[2], Vkd[2], angVel[2], false, false},
    {driveMotorNum[3], incEncNum[3], encoderType::inc, INC_CPR, driveCapableDuty, Vkp[3], Vki[3], Vkd[3], angVel[3], false, false},
  };
